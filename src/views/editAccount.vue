      ...
      <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
        ...
        <div class="-mx-3 md:flex mb-6">
          ...
          <div class="md:w-1/2 px-3">
            ...
            <input v-model="id" v-bind:class="generic_input_styles" id="identification" type="text" readonly="readonly"
        ...
        <div class="-mx-3 md:flex mb-6">
          ...
          <div class="md:w-1/2 px-3">
            ...
            <input v-model="password" v-bind:class="generic_input_styles" id="password" type="password" readonly="readonly" placeholder="***"
        ...
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input v-model="birthDate" v-bind:class="generic_input_styles" type="date" readonly="readonly" min="1920-01-01" max="2014-01-01"
          ...
          <div class="md:w-1/2 px-3">
            ...
            <div class="autocomplete" style="display: grid;">
              <input id="birtPlace" type="text" readonly="readonly" name="birtPlace" placeholder="Pereira, Risaralda">
            </div>
          </div>
        </div>
        <div class="-mx-3 md:flex mb-6">
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input v-bind:class="generic_input_styles" id="email" type="email" readonly="readonly" placeholder="Pepito0102@eltintero.com"
    ...
    methods: {
      register: async function (e) {
        ...
        if (data.status === 200 || data.status === 201){
          ...
          snackBar.showSnackBar("¡Los cambios se guardaron correctamente!");
          window.location = '/';
        }
        else{
          alert("No se pudieron guardar los cambios, por favor intente de nuevo")
        }
      }
    }
  }
