...
const routes = [
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/RecargarSaldo.vue"),
  },
  {
    path: "/NuevaTarjeta",
    name: "NuevaTarjeta",
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/NuevaTarjeta.vue"),
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/historialCompras.vue"),
  },
  {
    path: "/CrearTienda",
    name: "CrearTienda",
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/CrearTienda.vue"),
  },
  {
    path: "/CarritoCompras",
    name: "CarritoCompras",
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/CarritoCompras.vue"),
  },
